...
@Component({
  selector: 'app-subsidiaries-financials',
  templateUrl: './subsidiaries-financials.component.html',
  styleUrls: ['./subsidiaries-financials.component.css']
})
export class SubsidiariesFinancialsComponent {
    docs1: any;
